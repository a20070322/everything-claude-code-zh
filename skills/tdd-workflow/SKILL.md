---
name: tdd-workflow
description: 在编写新功能、修复错误或重构代码时使用此技能。强制执行测试驱动开发，要求 80% 以上的覆盖率，包括单元测试、集成测试和 E2E 测试。
---

# 测试驱动开发工作流

此技能确保所有代码开发遵循 TDD 原则并具有全面的测试覆盖。
...
// 测试相互依赖
test('creates user', () => { /* ... */ })
test('updates same user', () => { /* 依赖于上一个测试 */ })
```
